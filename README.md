...
# Wifi Show Password with Python
## Deployment

To deploy this project run
On Window Or MacOS Or Linux With The Help OF Your Favourate IDLE
...
print(R+br)
print(G+'''
[Check Every Saved Wifi Password ]
Coded By CodeAx1
